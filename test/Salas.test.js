...
let salas = [];
jest.mock('../src/domain/repository/mysql/SalaRepository', () => {
...
const SalaRepository_1 = __importDefault(require("../src/domain/repository/mysql/SalaRepository"));
const FindByNomeSala_1 = __importDefault(require("../src/domain/use-case/Sala/FindByNomeSala"));
const CreateSala_1 = __importDefault(require("../src/domain/use-case/Sala/CreateSala"));
const UpdateSala_1 = __importDefault(require("../src/domain/use-case/Sala/UpdateSala"));
const FindAllSala_1 = __importDefault(require("../src/domain/use-case/Sala/FindAllSala"));
const FindByIdSala_1 = __importDefault(require("../src/domain/use-case/Sala/FindByIdSala"));
const DeleteSala_1 = __importDefault(require("../src/domain/use-case/Sala/DeleteSala"));
const FindByBloco_1 = __importDefault(require("../src/domain/use-case/Sala/FindByBloco"));
describe("Sala", () => {
    let findAllSala;
    let findByNomeSala;
    let findById;
    ...
    let findByBloco;
    beforeEach(() => {
        const mockedRepository = new SalaRepository_1.default();
        createSala = new CreateSala_1.default(mockedRepository);
        updateSala = new UpdateSala_1.default(mockedRepository);
        deleteSala = new DeleteSala_1.default(mockedRepository);
        findById = new FindByIdSala_1.default(mockedRepository);
        findByNomeSala = new FindByNomeSala_1.default(mockedRepository);
        findAllSala = new FindAllSala_1.default(mockedRepository);
        findByBloco = new FindByBloco_1.default(mockedRepository);
    });
    afterEach(() => {
        salas = [];
    });
